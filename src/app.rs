    ...
    pub fn on_tick(&mut self) {
        ...
        for data in results {
            ...
            let row = vec![
                data.id.to_string(),
                data.url.clone(),
                data.elements.title.clone(),
                data.elements.title.len().to_string(),
                data.elements.h1.clone(),
                data.elements.h1.len().to_string(),
                data.elements.description.clone(),
                data.elements.description.len().to_string(),
                data.elements.h2.clone(),
                data.elements.h2.len().to_string(),
                data.status.clone(),
                data.elements.mobile.to_string(),
                data.elements.language.to_string(),
                data.elements.indexability.to_string(),
                data.elements.anchor_links.len().to_string(),
            ];
